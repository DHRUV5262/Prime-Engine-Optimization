...
#include "Characters/AnimationLODComponent.h"
	...
	// start root
	{
		...
		// start root.CharacterControl
		{
			...
			// start root.CharacterControl.Components
			{
				...
				// registering the partial animation state machine
				PartialAnimationSM::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				...
				TankLODComponent::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				AnimationLODComponent::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
			}
			...
			// start root.CharacterControl.Events
			{
				...
				Event_CreateTank::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
