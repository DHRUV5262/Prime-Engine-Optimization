...
namespace Components {
    ...
    struct TankController : public PE::Components::Component
    {
		...
		void setLODMeshes(PE::Handle hHighMesh, PE::Handle hLowMesh);
		PE::Handle getHighLODMesh() const { return m_hHighLODMesh; }
		PE::Handle getLowLODMesh() const { return m_hLowLODMesh; }
	...
	private:
		PE::Handle m_hHighLODMesh;
		PE::Handle m_hLowLODMesh;
