...
// Event for creating a Tank with LOD support (data-driven from Lua meta files)
struct Event_CreateTank : public PE::Events::Event_CREATE_MESH
{
	PE_DECLARE_CLASS(Event_CreateTank);

	Event_CreateTank(int &threadOwnershipMask): PE::Events::Event_CREATE_MESH(threadOwnershipMask){}
	...
	// Low poly mesh for LOD
	char m_lowMeshFilename[255];
	char m_lowMeshPackage[255];
