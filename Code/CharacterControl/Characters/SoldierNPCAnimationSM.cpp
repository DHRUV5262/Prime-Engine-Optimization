...
{ 
	//OutputDebugStringA("do_SoldierNPCAnimSM_Event_STOP\n");
...
{
	//OutputDebugStringA("do_SoldierNPCAnimSM_Event_WALK\n");
	if (m_curId != SoldierNPCAnimationSM::WALK)
	{
		m_curId = SoldierNPCAnimationSM::WALK;
		setAnimation(0, SoldierNPCAnimationSM::WALK,
...
void SoldierNPCAnimationSM::playStandShoot()
{
	OutputDebugStringA("playStandShoot\n");
	m_curId = SoldierNPCAnimationSM::STAND_SHOOT;
	setAnimation(0, SoldierNPCAnimationSM::STAND_SHOOT, 0, 0, 1, 1, 0);
}
